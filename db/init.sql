...
(
    ...
    'Лев Толстой',
    1869,
    xmlparse(document '<toc><h1>Том первый</h1><h2>Часть первая</h2><p>Глава I. Салон Анны Павловны Шерер</p><p>Глава II. Пьер Безухов в салоне</p><h2>Часть вторая</h2><p>Глава I. Смотр под Браунау</p></toc>')
),
(
    'Преступление и наказание',
    'Фёдор Достоевский',
    1866,
    xmlparse(document '<toc><h1>Часть первая</h1><p>Глава 1. Проба</p><p>Глава 2. Мармеладовы</p><h1>Часть вторая</h1><p>Глава 1. Признание</p></toc>')
),
(
    'Мастер и Маргарита',
    'Михаил Булгаков',
    1967,
    xmlparse(document '<toc><h1>Часть первая</h1><h2>Глава 1. Никогда не разговаривайте с неизвестными</h2><h2>Глава 2. Понтий Пилат</h2><h1>Часть вторая</h1><h2>Глава 19. Маргарита</h2></toc>')
);